...
import com.xue.bigdata.utils.MoreSuppliers;

/**
 * @author: mingway
 * @date: 2022/8/12 10:57 PM
 */
public class ProtobufUtils {
    ...
    public static Descriptors.Descriptor getDescriptor(byte[] descriptorBytes) {
        ...
        List<DescriptorProtos.FileDescriptorProto> fileDescriptorProtos = fileDescriptorSet.getFileList();
        Map<String, DescriptorProtos.FileDescriptorProto> protoNameFileDescriptorProtoMapper = fileDescriptorProtos
                .stream()
