...
public class CityHash {
    ...
    public static BigInteger UIntHash64(String Str){
        long dt = cityHash64(Str.getBytes(StandardCharsets.UTF_8),0, Str.length());
        BigInteger b1 = BigInteger.valueOf(dt);
        BigInteger b2 = BigInteger.valueOf(9223372036854775807L);
        return b2.add(b1);
    }
    ...
    private static Long reversalByte(Long l ){
